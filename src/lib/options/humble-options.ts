...
/**
 * The default set of Humble options.
 */
const defaultOptionSet: HumbleOptions = {
  url: null,
  out: null,
  useTitle: false,
  silent: false,
 ...
 * resources.
 */
const sanitizeOptionSet: HumbleOptions = {
  url: null,
 ...
 */
const compatibilityOptionSet: HumbleOptions = {
  url: null,
...
/**
 * A set of options for page beautification.
 */
const beautificationOptionSet: HumbleOptions = {
  url: null,
  beautifyHtml: true,
  beautifyCss: true,
  beautifyJs: true,
 ...
 */
const simpleMinificationOptionSet: HumbleOptions = {
  url: null,
  minifyHtml: true,
  minifyCss: true,
  minifyJs: true,
 ...
 */
const advancedMinificationOptionSet: HumbleOptions = {
  url: null,
...
/**
 * A set of options for extreme page minification that will very likely break
 * page functionality and have an effect on page rendering.
 */
const extremeMinificationOptionSet: HumbleOptions = {
  url: null,
  addScriptCSP: false,
  addFrameCSP: false,
 ...
 */
export const HumblePrebuiltOptions: {
  ...
  EXTREME_MINIFICATION: {
    ...defaultOptionSet,
    ...sanitizeOptionSet,
    ...simpleMinificationOptionSet,
    ...advancedMinificationOptionSet,
    ...extremeMinificationOptionSet,
  },
};
